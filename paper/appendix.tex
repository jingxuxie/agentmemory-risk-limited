...
\begin{figure}[t]
\centering\includegraphics[width=.9\linewidth]{figures/evidence.pdf}
...
\begin{figure}[t]
\centering\includegraphics[width=.9\linewidth]{figures/misspecification.pdf}
...
\begin{figure}[t]
\centering\includegraphics[width=.8\linewidth]{figures/rollout_check.pdf}
...
\begin{figure}[t]
\centering\includegraphics[width=.9\linewidth]{figures/grouping_stable.pdf}
...
\end{figure}
\begin{figure}[t]
\centering\includegraphics[width=.9\linewidth]{figures/grouping_active.pdf}
